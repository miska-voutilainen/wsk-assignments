...
// Funktio ravintoloiden lisäämiseksi taulukkoon
function addRestaurantsToTable() {
  const tableBody = document.querySelector('table');
  
  // Käydään läpi kaikki ravintolat
  restaurants.forEach(restaurant => {
    // Luodaan uusi rivi taulukkoon
    const row = document.createElement('tr');

    // Luodaan solut ravintolan nimeä ja osoitetta varten
    const nameCell = document.createElement('td');
    const addressCell = document.createElement('td');

    // Asetetaan solujen sisältö
    ...
    // Lisää rivin taulukon bodyyn
    tableBody.appendChild(row);
  });
}

// Käynnistetään funktio, kun sivu on ladattu
document.addEventListener('DOMContentLoaded', addRestaurantsToTable);