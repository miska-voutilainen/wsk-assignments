...
// Alustetaan kartta
const map = L.map('map').setView([60.169096, 24.950631], 12); // Kartan keskipiste ja zoom-taso

// Lisätään OpenStreetMap kerros kartalle
L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
  attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
}).addTo(map);

// Käydään läpi ravintolat ja lisätään jokainen markeriksi kartalle
restaurants.forEach(restaurant => {
  const marker = L.marker([restaurant.location.coordinates[1], restaurant.location.coordinates[0]]).addTo(map);
  
  // Lisää klikattaessa popup, jossa näytetään ravintolan nimi ja osoite
  marker.bindPopup(`
